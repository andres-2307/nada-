...
<section class="container-fluid col-12 mt-5 py-5">
    <div>
        <h1 class="text-center font-weight-bold ">Curso de Ingeniería de Software</h1>
    </div>
    <div id="carouselExampleFade" class=" carousel slide carousel-fade" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="../imagenes/moderno2.png" class=" w-100 " alt="soy una imagen" height="350">
            </div>
            <div class="carousel-item ">
                <img src="../imagenes/moderno1.jpg" class=" w-100 " alt="soy una imagen" height="350">
            </div>
            <div class="carousel-item">
...
<section class="container-fluid  videos ">
    <div class="row ">
        ...
        $consulta = "SELECT  numero_u,link  FROM datos_video ORDER by numer";
        ...
        ?>
            <div class="col-12 col-sm-6 col-md-3 pb-5">
                <div class="card pb-4 h-100">
                    ...
                    <iframe height=200 src="<?php echo $mostrar['link'] ?>" frameborder="2" allowfullscreen="allowfullscreen"></iframe>
                </div>
            </div>
        <?php
        }

...
<head>
    ...
    <title>AppIngSoftware</title>
    <link rel="shortcut icon" href="../imagenes/unicordoba.ico" />
</head>
                ...
                ?>
                    <div class="dropdown show px-3">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            ...
                            <a class="dropdown-item" data-toggle="modal" data-target="#ventana_modal3" role="button" href=""> <h6>Opcion de Docente</h6></a>
                        </div>
                    </div>
                <?php
